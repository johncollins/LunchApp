...
def add_person(request, year, month):
    """Add a person to the program for a given month and year 
    ...
    try:    
        ...
        month.add_person(person) # add the new person to the signed_up list
        message = 'successfully signed %s up for %s; email confirmation sent' % (person, month)
    except:
        person = Person()
        person.name=''
        person.email=''
...
def remove_person(request, year, month):
    """Remove a person to the program for a given month and year 
